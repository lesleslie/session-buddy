...
2. Confidence scoring for all relationships (low/medium/high)
3. Transitive relationship discovery (A→B→C implies A→C)
4. Pattern extraction from entity observations
...
3. `related_to` - default/low similarity (low confidence)
...
2. `session_buddy/mcp/tools/collaboration/knowledge_graph_tools.py` - MCP tools
