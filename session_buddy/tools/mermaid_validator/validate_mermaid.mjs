...
//
// Designed for the session-buddy CI guard (test_mermaid_renders.py +
// `session-buddy docs check-mermaid`). Uses mermaid.parse() — the lexer-only
...
//
// The Python wrapper (session_buddy.tools.mermaid_validator.renderer) computes
// both absolute paths and passes them as argv[2] and argv[3]. Each path is
// loaded via dynamic `import()` because Node ESM does NOT honor NODE_PATH for
// static imports (v18+).
