...
def register_conversation_tools(mcp_server: FastMCP) -> None:
    return _register_conversation_tools_impl(mcp_server)


def _register_conversation_tools_impl(mcp_server: FastMCP) -> None:
    """Register all conversation storage tools with the MCP server."""
    _register_store_conversation_tool(mcp_server)
    _register_store_conversation_checkpoint_tool(mcp_server)
    _register_get_conversation_statistics_tool(mcp_server)
    _register_search_conversations_tool(mcp_server)


def _register_store_conversation_tool(mcp_server: FastMCP) -> None:
    @mcp_server.tool()
...
def _register_store_conversation_checkpoint_tool(mcp_server: FastMCP) -> None:
    @mcp_server.tool()
...
def _register_get_conversation_statistics_tool(mcp_server: FastMCP) -> None:
    @mcp_server.tool()
...
def _register_search_conversations_tool(mcp_server: FastMCP) -> None:
    @mcp_server.tool()
