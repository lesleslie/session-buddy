...
ASSIGNMENTS: dict[str, tuple[str, str, str]] = {
    ...
    "docs/PHASE2_3_SINGLETON_CLEANUP_PLAN.md": (
        "complete",
        "historical",
        "architecture",
    ),
    ...
    "docs/test_improvements_documentation.md": (
        "complete",
        "historical",
        "architecture",
    ),
    ...
    "docs/MEMORI_INTEGRATION_PATHWAYS.md": (
        "complete",
        "historical",
    ...
    "docs/SESSION_ANALYTICS_IMPLEMENTATION.md": (
        "complete",
        "historical",
        "observability",
    ),
    ...
    "docs/ULID_MIGRATION_ANALYSIS.md": (
        "complete",
        "historical",
    ...
    "docs/natural_language_intent_detection.md": (
        "complete",
        "canonical",
        "learning-pipeline",
    ),
    ...
    "collaborative_filtering_quick_reference.md": (
        "complete",
        "canonical",
        "learning-pipeline",
    ),
    ...
    "scripts/TAXONOMY_INITIALIZATION_QUICKSTART.md": (
        "complete",
        "canonical",
        "architecture",
    ),
    ...
    "session_buddy/trailing_period_removal_summary.md": (
        "complete",
        "historical",
        "architecture",
    ),
    ...
    "docs/design/MULTI_PROJECT_COORDINATOR.md": (
        "complete",
        "canonical",
        "architecture",
    ),
    "docs/design/REFLECTION_DATABASE.md": (
        "complete",
        "canonical",
        "memory-architecture",
    ),
    "docs/design/REFLECTION_SYSTEM.md": (
        "complete",
        "canonical",
        "memory-architecture",
    ),
    "docs/design/SERVERLESS_MODE.md": (
        "complete",
        "canonical",
        "storage-consolidation",
    ),
    ...
    "docs/features/hooks_and_causal_chains.md": (
        "complete",
        "canonical",
        "architecture",
    ),
    ...
    # ----- docs/guides/ -----
    "docs/guides/operational-modes-architecture.md": (
        "complete",
        "canonical",
        "architecture",
    ),
    ...
    # ----- docs/initialization/ -----
    "docs/initialization/TAXONOMY_INITIALIZATION.md": (
        "complete",
        "canonical",
        "architecture",
    ),
    # ----- docs/integration/ -----
    "docs/integration/phase3_intelligence_integration_complete.md": (
        "complete",
        "historical",
        "learning-pipeline",
    ),
    # ----- docs/migrations/ -----
    "docs/migrations/ONEIRIC_MIGRATION_COMPLETE.md": (
        "complete",
        "historical",
        "oneiric-config",
    ),
    "docs/migrations/ONEIRIC_MIGRATION_PLAN.md": (
        "complete",
        "historical",
        "oneiric-config",
    ),
    "docs/migrations/README.md": ("complete", "canonical", "oneiric-config"),
    "docs/migrations/V3_TO_V4_MIGRATION_GUIDE.md": (
        "complete",
        "historical",
        "oneiric-config",
    ),
    "docs/migrations/health-check-implementation.md": (
        "complete",
        "historical",
        "lifecycle",
    ),
    ...
    # ----- docs/performance/ -----
    "docs/performance/embedding_cache_results.md": (
        "complete",
        "historical",
        "observability",
    ),
    "docs/performance/embedding_quantization_results.md": (
        "complete",
        "historical",
        "observability",
    ),
    "docs/performance/hnsw_benchmark_results.md": (
        "complete",
        "historical",
        "observability",
    ),
    ...
    "docs/realtime/WEBSOCKET_DELIVERY_REPORT.md": (
        "complete",
        "historical",
        "mcp-design",
    ),
    ...
    "docs/security/PHASE1_TEST_COVERAGE_ANALYSIS.md": (
        "complete",
        "historical",
        "auth",
    ),
    ...
    "docs/design/SKILL_METRICS_ARCHITECTURE.md": (
        "complete",
        "canonical",
        "learning-pipeline",
    ),
    "docs/design/SKILL_METRICS_AGGREGATION.md": (
        "complete",
        "canonical",
        "learning-pipeline",
    ),
    "docs/design/SKILL_METRICS_IMPLEMENTATION.md": (
        "complete",
        "canonical",
        "learning-pipeline",
    ),
    ...
    "commands/session-buddy-start.md": (
        "active",
        "canonical",
        "plugin-standardization",
    ),
    "commands/session-buddy-checkpoint.md": (
        "active",
        "canonical",
        "plugin-standardization",
    ),
    "templates/session/checkpoint.md": (
        "active",
        "canonical",
        "plugin-standardization",
    ),
